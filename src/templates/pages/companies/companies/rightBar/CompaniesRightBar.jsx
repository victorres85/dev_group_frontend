...
const CompaniesRightBar = ({ selectedCompany }) => {
    const users = selectedCompany?.users;
    const stacks = selectedCompany?.stacks;
    const softwares = selectedCompany?.softwares;
  ...
  return (
    ...
    <div className="card">
            <div className="card-header d-flex flex-row justify-content-between align-items-center mb-0">
              <h4 className="mb-0" style={{lineHeight:'36px'}}>{selectedCompany?.name ? `${capitalize(selectedCompany.name)} info:` : 'Company info:'}</h4>
...
export default CompaniesRightBar;